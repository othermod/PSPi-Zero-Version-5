...
// Arduino Commands (One Byte. Byte 2 Will Be Ignored)
#define ATMEGA_ENTER_SLEEP_MODE 0x00
#define ATMEGA_ENTER_ACTIVE_MODE 0x01
#define ATMEGA_UNMUTE_AUDIO 0x02
#define ATMEGA_MUTE_AUDIO 0x03
#define ATMEGA_FORCE_ORANGE_LED 0x04
#define ATMEGA_UNFORCE_ORANGE_LED 0x05
...
void sleepMode(){
  ...
  buf[0] = ATMEGA_ENTER_ACTIVE_MODE;
  if (write(I2CFile,buf,1) != 1) {
			/* ERROR HANDLING: i2c transaction failed */
